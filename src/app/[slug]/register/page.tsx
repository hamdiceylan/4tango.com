...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`/api/public/events/${params.slug}/register`, {
        method: "POST",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-2xl mx-auto px-4 py-4">
          <Link href={`/${event.slug}`} className="text-gray-500 hover:text-rose-500 transition flex items-center gap-2">
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <p className="text-center text-gray-400 text-sm mt-8">
          Powered by <Link href="/" className="text-rose-500 hover:underline">4Tango</Link>
        </p>
      </div>
    </div>
  );
