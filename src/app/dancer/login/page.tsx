...
export default function DancerLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/auth/dancer/login", {
        method: "POST",
  ...
  const handleSocialLogin = (provider: string) => {
    // Redirect to Cognito hosted UI with provider
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Sign in to your dancer account</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            ...
            <Link href="/dancer/signup" className="text-rose-500 hover:underline font-medium">
              Sign up
            </Link>
          </p>
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            <Link href="/login" className="hover:underline">
              Are you an event organizer? Sign in here
            </Link>
          </p>
        </div>
      </div>
